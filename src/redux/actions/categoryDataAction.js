...
export const getCategoryDataAction = (page = 1, limit = 10) => {
    return async (dispatch) => {
        ...
        try {
            const res = await axiosClient.get(`/category/get-all?page=${page}&limit=${limit}`);
...
export const createCategory = (categoryName) => {
    return async (dispatch) => {
        ...
        try {
            const res = await axiosClient.post("/category/create", { name: categoryName });
...
export const deleteCategory = (categoryId) => {
    return async (dispatch) => {
        ...
        try {
            const res = await axiosClient.delete(`/category/delete/${categoryId}`);
...
export const moveCategoryDataAction = (categoryId, toIndex) => {
    return async (dispatch, getState) => {
        ...
        try {
            ...
            // api call
            const res = await axiosClient.put('/category/move', {
