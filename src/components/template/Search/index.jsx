...
import { getSettingsNavigation } from "app/navigation/settings";
import { NAV_TYPE_COLLAPSE } from "constants/app.constant";
import { Highlight } from "components/shared/Highlight";

// ----------------------------------------------------------------------

// Build flattened search data from all navigation sections 
const data = flattenNav([...getNavigation(), getSettingsNavigation()]);
